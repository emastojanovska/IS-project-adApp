    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingsInWishlist", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListingsInWishlist_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListingsInWishlist_Wishlists_WishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingsInWishlist_ListingId",
                table: "ListingsInWishlist",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_ListingsInWishlist_WishlistId",
                table: "ListingsInWishlist",
                column: "WishlistId");
